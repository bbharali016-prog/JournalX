  ...
  return (
    <PublicLayout>
      <section className="relative mx-auto max-w-[1420px] px-5 py-5 lg:px-10">
        ...
        <section id="roadmap" className="py-20 border-b border-white/10 scroll-mt-24 relative overflow-hidden">
          {/* Subtle background glow */}
          <div className="absolute right-[20%] top-[40%] h-[350px] w-[350px] rounded-full bg-cyan-600/5 blur-3xl pointer-events-none" />
          <div className="absolute left-[20%] bottom-[20%] h-[350px] w-[350px] rounded-full bg-violet-600/5 blur-3xl pointer-events-none" />
          ...
          <div className="text-center space-y-4 mb-16 px-4">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
              JournalX Platform Architecture
            </h2>
            <p className="text-slate-400 text-sm max-w-xl mx-auto leading-relaxed">
              Explore the full technological stack and functional breakdown behind our trading journal ecosystem.
            </p>
          </div>

          {/* Mindmap / Tree Diagram Container */}
          <div className="max-w-5xl mx-auto px-4 relative">
            
            {/* Desktop View: Branching Tree Diagram */}
            <div className="hidden md:flex items-stretch justify-between relative py-6">
              
              {/* Column 1: Root Node (Left) */}
              <div className="flex flex-col justify-center items-center w-1/4 z-10 relative">
                <div className="rounded-2xl border-2 border-teal-500 bg-[#090f1d] px-6 py-4 text-center shadow-[0_0_20px_rgba(20,184,166,0.2)]">
                  <Code className="h-6 w-6 text-teal-400 mx-auto mb-2" />
                  <h4 className="text-sm font-bold text-white uppercase tracking-wider">Web Development</h4>
                  <p className="text-[10px] text-teal-300 font-semibold mt-0.5">JournalX App</p>
                </div>
              </div>

              {/* Column 2: Branches (Center) */}
              <div className="flex flex-col justify-around items-center w-1/4 z-10 relative py-8 min-h-[500px]">
                {/* Front End Branch Node */}
                <div className="rounded-xl border border-cyan-400/30 bg-[#0d1527] px-5 py-3 text-center shadow-lg w-44">
                  <Laptop className="h-5 w-5 text-cyan-300 mx-auto mb-1.5" />
                  <h5 className="text-xs font-bold text-white">Front End</h5>
                </div>

                {/* Back End Branch Node */}
                <div className="rounded-xl border border-violet-400/30 bg-[#0d1527] px-5 py-3 text-center shadow-lg w-44">
                  <Server className="h-5 w-5 text-violet-300 mx-auto mb-1.5" />
                  <h5 className="text-xs font-bold text-white">Back End</h5>
                </div>
              </div>

              {/* Column 3: Category Nodes (Right Center) */}
              <div className="flex flex-col justify-between w-2/5 z-10 relative py-4 min-h-[600px] pl-4">
                
                {/* Front End Category Groups */}
                <div className="space-y-6">
                  {/* Category 1: Language */}
                  <div className="flex items-center gap-4">
                    <div className="rounded-lg border border-cyan-500/25 bg-cyan-500/5 px-4 py-2 text-xs font-semibold text-cyan-300 w-32 shrink-0">
                      Language 🗣️
                    </div>
                    <div className="flex gap-2 flex-wrap">
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">HTML5</span>
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">CSS3</span>
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">JavaScript</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex gap-2 flex-wrap">
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300 font-bold text-cyan-300">React.js</span>
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">Next.js (App)</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex gap-2 flex-wrap">
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">Tailwind CSS</span>
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">Lightweight Charts</span>
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">Lucide Icons</span>
                    </div>
                  </div>
                </div>

                {/* Divider Line */}
                <div className="border-t border-white/5 my-4 w-full" />

                {/* Back End Category Groups */}
                <div className="space-y-6">
                  {/* Category 4: Language */}
                  <div className="flex items-center gap-4">
                    <div className="rounded-lg border border-violet-500/25 bg-violet-500/5 px-4 py-2 text-xs font-semibold text-violet-300 w-32 shrink-0">
                      Language 🗣️
                    </div>
                    <div className="flex gap-2 flex-wrap">
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300 font-bold text-violet-300">Python (3.12)</span>
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">Node.js</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex gap-2 flex-wrap">
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300 font-bold text-teal-400">PostgreSQL</span>
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">SQLAlchemy</span>
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">Alembic</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex gap-2 flex-wrap">
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">FastAPI REST</span>
                      <span className="text-[10px] bg-slate-800/80 border border-white/5 px-2.5 py-1 rounded-md text-slate-300">JWT Token Auth</span>
                    </div>
                  </div>
                </div>
              ...
              {/* Dynamic SVG Branch Lines Drawing */}
              <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-30" style={{ zIndex: 0 }}>
                {/* Line 1: Root to Front End */}
                <path d="M 170 300 C 230 300, 210 180, 280 180" fill="none" stroke="#22d3ee" strokeWidth="2" />
                {/* Line 2: Root to Back End */}
                <path d="M 170 300 C 230 300, 210 420, 280 420" fill="none" stroke="#a78bfa" strokeWidth="2" />
                
                {/* Line 3: Front End to Language */}
                <path d="M 440 180 C 470 180, 480 80, 520 80" fill="none" stroke="#22d3ee" strokeWidth="1.5" />
                {/* Line 4: Front End to Framework */}
                <path d="M 440 180 C 470 180, 480 180, 520 180" fill="none" stroke="#22d3ee" strokeWidth="1.5" />
                {/* Line 5: Front End to Libraries */}
                <path d="M 440 180 C 470 180, 480 280, 520 280" fill="none" stroke="#22d3ee" strokeWidth="1.5" />

                {/* Line 6: Back End to Language */}
                <path d="M 440 420 C 470 420, 480 370, 520 370" fill="none" stroke="#a78bfa" strokeWidth="1.5" />
                {/* Line 7: Back End to Database */}
                <path d="M 440 420 C 470 420, 480 470, 520 470" fill="none" stroke="#a78bfa" strokeWidth="1.5" />
                {/* Line 8: Back End to API */}
                <path d="M 440 420 C 470 420, 480 570, 520 570" fill="none" stroke="#a78bfa" strokeWidth="1.5" />
              </svg>
            </div>

            {/* Mobile View: Vertical Roadmap Grid */}
            <div className="block md:hidden space-y-8">
              <div className="rounded-2xl border border-teal-500 bg-[#090f1d] p-5 text-center">
                <Code className="h-6 w-6 text-teal-400 mx-auto mb-2" />
                <h4 className="text-sm font-bold text-white uppercase tracking-wider">Web Development Stack</h4>
              </div>
              
              <div className="space-y-6">
                {/* Front End Mobile */}
                <div className="space-y-4 rounded-xl border border-cyan-400/25 bg-[#0a1120] p-4">
                  <div className="flex items-center gap-2 text-cyan-300 font-bold border-b border-white/5 pb-2">
                    <Laptop className="h-4 w-4" />
                    <span>Front End Engine</span>
                  </div>
                  <div className="space-y-3.5 text-xs">
                    <div>
                      <p className="text-slate-400 font-semibold mb-1">Language</p>
                      <div className="flex flex-wrap gap-1.5">
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">HTML5</span>
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">CSS3</span>
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">JavaScript</span>
                      </div>
                    </div>
                    <div>
                      <p className="text-slate-400 font-semibold mb-1">Framework</p>
                      <div className="flex flex-wrap gap-1.5">
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">React.js</span>
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">Next.js</span>
                      </div>
                    </div>
                    <div>
                      <p className="text-slate-400 font-semibold mb-1">Libraries</p>
                      <div className="flex flex-wrap gap-1.5">
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">Tailwind CSS</span>
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">Lightweight Charts</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* Back End Mobile */}
                <div className="space-y-4 rounded-xl border border-violet-400/25 bg-[#0a1120] p-4">
                  <div className="flex items-center gap-2 text-violet-300 font-bold border-b border-white/5 pb-2">
                  ...
                  <div className="space-y-3.5 text-xs">
                    <div>
                      <p className="text-slate-400 font-semibold mb-1">Language</p>
                      <div className="flex flex-wrap gap-1.5">
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">Python</span>
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">Node.js</span>
                      </div>
                    </div>
                    <div>
                      <p className="text-slate-400 font-semibold mb-1">Database</p>
                      <div className="flex flex-wrap gap-1.5">
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">PostgreSQL</span>
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">SQLAlchemy</span>
                      </div>
                    </div>
                    <div>
                      <p className="text-slate-400 font-semibold mb-1">API &amp; Security</p>
                      <div className="flex flex-wrap gap-1.5">
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">FastAPI</span>
                        <span className="bg-slate-800 px-2 py-0.5 rounded text-[10px]">JWT Auth</span>
                      </div>
                    </div>
                  </div>
                </div>
